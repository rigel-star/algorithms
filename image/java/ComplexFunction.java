...
public class ComplexFunction extends JPanel {
	...
	public static Complex function(double x) {
		Complex z1 = new Complex(x * x, 4);
		Complex z2 = new Complex(x * x, 9);
		return Complex.divide(z1, z2);
	}
	
	
	public static Complex func(Complex z) {
		Complex z2 = new Complex(1, 4);
		Complex sq = Complex.multiply(z, z);
		return Complex.divide(z, Complex.add(sq, z2));
	}
	

	public static Complex function1(Complex z) {
	...
	public static Complex function2(Complex z, int depth) {
		if (depth == 1) {
